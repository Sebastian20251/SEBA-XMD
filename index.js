...
const clientstart = async() => {
    ...
    if (config().status.terminal && !sock.authState.creds.registered) {
        const phoneNumber = await question('Enter your WhatsApp number, starting with 255:\nnumber WhatsApp: ');
        ...
        if (connection === 'open') {
            ...
            sock.sendMessage(botNumber, {
                text:
                    ...
                    `📢 Join our channel: https://whatsapp.com/channel/0029Vb7URAs6RGJAdViztH3C`,
                contextInfo: {
                    forwardingScore: 1,
                    isForwarded: true,
                    externalAdReply: {
                        ...
                        sourceUrl: "https://whatsapp.com/channel/0029Vb7URAs6RGJAdViztH3C",
                        mediaType: 1,
